...
class MarketDataService:
    ...
    def with_default_cache(
        ...
        *,
        ...
        return cls(client=client, cache=SQLiteCache(cache_path), local_store=local_store)
    ...
    def get_prices(
        ...
        *,
        ...
        local_rows = self._get_local_prices(
            region=region,
            item_ids=item_ids,
            locations=locations,
            qualities=qualities,
